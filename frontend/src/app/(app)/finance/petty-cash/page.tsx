  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <h1 className="text-2xl font-semibold">Petty Cash Funds</h1>
          <p className="mt-1 text-sm text-zinc-500">
            The cash boxes themselves: floats, replenishments, and adjustments. Cash leaves a fund either as an advance (IOU) before the spend, or as repayment on an expense voucher after it.
          </p>
        </div>
        {canCreate ? (
