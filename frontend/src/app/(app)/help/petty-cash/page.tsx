...
const scenarios: Scenario[] = [
  ...
  },
  {
    ...
    who: "Technician, receiver, assigned approver, then head office",
    lede: "The job team requests the money; operational and head-office approvals are recorded before the accountant hands over cash.",
    steps: [
      ...
      <><em>Receiver:</em> open the IOU, click <Btn>Send for Approval</Btn>, and select the person responsible for checking the job advance.</>,
      <><em>Assigned approver:</em> edit the job, amount, date or purpose if needed, then click <Btn>Approve &amp; Return</Btn>.</>,
      <><em>Receiver:</em> check the returned record and click <Btn>Submit to Head Office</Btn>. Head office gives final approval.</>,
      <>When the relevant employee comes to collect, Finance clicks <Btn>Release Cash</Btn>.</>,
