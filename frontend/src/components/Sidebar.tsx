...
const sections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/sales/direct-dispatches", label: "AOD" },
      { href: "/sales/invoices", label: "Final Invoices" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/service/dispatch-board", label: "Dispatch Board" },
      { href: "/service/technician-workbench", label: "Technician Workbench" },
      ...
      { href: "/service/technicians", label: "Technicians" },
      { href: "/service/estimates", label: "Quotations" },
      { href: "/service/expense-claims", label: "Expense Vouchers" },
      { href: "/service/work-orders", label: "Job Sheets / Work Orders" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/finance/petty-cash", label: "Petty Cash Funds" },
