...
public static class ReferenceDataSeeder
{
    ...
    [
        ...
        new("SJ", "Job Order", "Service", "/service/jobs/{id}"),
        new("SE", "Quotation", "Service", "/service/estimates/{id}"),
        new("SEC", "Petty Cash", "Service", "/service/expense-claims/{id}"),
        new("WO", "Job Detail / Job Sheet", "Service", "/service/work-orders/{id}"),
        new("MR", "Material Request Note (MRN)", "Service", "/service/material-requisitions/{id}"),
        new("QC", "Inspection / QC", "Service", "/service/quality-checks/{id}"),
        new("SH", "Service Taken / Delivery Confirmation", "Service", "/service/handovers/{id}"),
