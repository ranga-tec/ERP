...
public static class AppPermissions
{
    ...
    public const string PettyCashIouReview = "Finance.PettyCashIou.Review";
    public const string PettyCashIouAssignedApprove = "Finance.PettyCashIou.AssignedApprove";
    ...
    [
        ...
        new(PettyCashIouEdit, "Finance / Petty Cash IOU", "Edit", "Edit IOUs", "Change draft/submitted IOUs or an IOU assigned to the current approver."),
        new(PettyCashIouSubmit, "Finance / Petty Cash IOU", "Submit", "Submit IOUs", "Submit IOUs for approval."),
        new(PettyCashIouReview, "Finance / Petty Cash IOU", "Review", "Receive and forward IOUs", "Assign submitted IOUs and forward reviewed requests to head office."),
        new(PettyCashIouAssignedApprove, "Finance / Petty Cash IOU", "Assigned approval", "Approve assigned IOUs", "Review and approve IOUs specifically assigned to the user."),
        new(PettyCashIouApprove, "Finance / Petty Cash IOU", "Approve", "Head-office approval", "Give final head-office approval to reviewed IOU requests."),
